...
separator theorem  \cite{LiTa} which shows the separators are of size
...
\end{definition}
All the polytopes formed this way are combinatorially equivalent (but not 
...
called the \textit{vertex figure} of the vertex $v$. Vertex cuts can be generalized to cutting of 
